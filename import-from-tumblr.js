var HOSTNAME = 'mattquirion.tumblr.com'
var DST_DIR = '/Users/mattquirion/Development/mquirion.github.io/_posts'
...
function import_posts(offset, final_callback) {
  ...
  var path = '/api/read/json?filter=none&num=25&start='+(offset || '0')
